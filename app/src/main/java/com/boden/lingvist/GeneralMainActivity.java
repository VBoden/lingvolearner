...
public class GeneralMainActivity extends Activity {
	public static final String APP_PREFERENCES = "LingvistPrefs";
	public static final String KILK_POVT = "kilk_povt";
	...
	public static final int USE_GOOGLE_TTS = 1;
	public static final int USE_FLITE_TTS = 2;
}
